//
//  RehabSportsView.swift
//  QuestMe
//
//  📂 格納場所:
//      QuestMe/UI/RehabSportsView.swift
//
//  🎯 ファイルの目的:
//      リハビリ・スポーツ科学分野の話題とニュースを表示し、感情同期と音声案内を提供する。
...
struct RehabSportsView: View {
    ...
    var body: some View {
        ...
        .padding()
        .onAppear {
            let text = "リハビリやスポーツ科学の話題を表示します。気になるテーマがあれば話しかけてください。"
