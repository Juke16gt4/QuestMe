//
//  NaturalScienceView.swift
//  QuestMe
//
//  📂 格納場所:
//      QuestMe/UI/NaturalScienceView.swift
//
//  🎯 ファイルの目的:
//      自然科学分野の話題とニュースを表示し、感情同期と音声案内を提供する。
...
struct NaturalScienceView: View {
    ...
    var body: some View {
        ...
        .padding()
        .onAppear {
            let text = "自然科学の話題を表示します。気になるテーマがあれば話しかけてください。"
